...
| Ticket | Status | Evidence |
|---|---|---|
| P3-SCAN-01 | Not started | No `AVFoundation`/camera code anywhere, and no `Views/` or `ViewModels/` under `Features/Scanner/` — only the three pure services `P3-SCAN-02`/`-04` landed. Note `Features/Scanner/README.md` still describes the capture UI, guidance overlays and review screen as things this module owns; none of that exists. |
